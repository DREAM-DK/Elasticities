# ============================================================
# 06a_estimate_mu_kalman_fixed_omega.R
#
# Purpose:
# Estimate the full CES consumption system with a state-space
# preference process using Kalman maximum likelihood.
#
# This version keeps omega fixed at the calibrated Paasche value.
# It is used as the stable benchmark version of the Kalman model.
#
# The model combines:
...
#
# Main outputs:
#   Data/results_mu_kalman_fixed_omega_1983_2017_paasche.csv
#   Data/residuals_mu_kalman_fixed_omega_1983_2017_paasche.csv
#   Data/states_mu_kalman_fixed_omega_1983_2017_paasche.csv
#
# ============================================================
...
write_csv(
  residuals_kalman,
  paste0(
    "Data/residuals_mu_kalman_fixed_omega_",
    start_year, "_", end_year,
    "_paasche.csv"
  )
)
...
write_csv(
  states_kalman,
  paste0(
    "Data/states_mu_kalman_fixed_omega_",
    start_year, "_", end_year,
    "_paasche.csv"
  )
)
