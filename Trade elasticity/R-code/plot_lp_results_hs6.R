...
res_dir <- file.path(base_path, "Merge_all_countries", "LP_results_HS6_paper")
...
fig1_png <- file.path(res_dir, "figure1_hs6_paper_tariffs_trade.png")
fig1_csv <- file.path(res_dir, "figure1_hs6_paper_plotdata.csv")
...
fig2_png <- file.path(res_dir, "figure2_hs6_paper_trade_elasticity.png")
fig2_csv <- file.path(res_dir, "figure2_hs6_paper_plotdata.csv")
